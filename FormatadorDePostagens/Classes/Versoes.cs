...
namespace FormatadorDePostagens
{
    public class Versoes
    {
        ...
        {
            String[] palavrasErradas = new string[] { " nfe ", " nf-e ", " nfce ", " nfc-e ", " nfse ", " nfs-e ", " cte ", " ct-e ", " nf ", " nfse ", " nfs-e ", " pis ", " cofins ", " cst ", " cfop ", " coi ", " icmsst ", " icms-st ", " icms ", " sped ", " ncm ", " ipi ", " inconsitencia ", " inconcistencia ", " inconsitência ", " inconcistência ", " Ajustado ", " inconsistencia ", " incôncistencia ", " xml ", " sat ", " qr code ", " inconcitência ", " f1 ", " f2 ", " f3 ", " f4 ", " f5 ", " f6 ", " f7 ", " f8 ", " f9 ", " f10 ", " f11 ", " f12 " };
            String[] palavrasCertas = new string[] { " NF-e ", " NF-e ", " NFC-e ", " NFC-e ", " NFS-e ", " NFS-e ", " CT-e ", " CT-e ", " NF ", " NFS-e ", " NFS-e ", " PIS ", " COFINS ", " CST ", " CFOP ", " COI ", " ICMS-ST ", " ICMS-ST ", " ICMS ", " SPED ", " NCM ", " IPI ", " inconsistência ", " inconsistência ", " inconsistência ", " inconsistência ", " Ajustada ", " inconsistência ", " inconsistência ", " XML ", " SAT ", " QR Code ", " inconsistência ", " F1 ", " F2 ", " F3 ", " F4 ", " F5 ", " F6 ", " F7 ", " F8 ", " F9 ", " F10 ", " F11 ", " F12 " };
            String descricao = "";
